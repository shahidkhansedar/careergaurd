    ...
    <script>
            ...
            table = $('#staffTable').DataTable({
                ...
                },
                {
                    ...
                    render: function (data) {
                        ...
                        let editUrl = "<?php echo e(route('staff.edit', ':slug')); ?>".replace(':slug', data.slug);
                        return `
        ...
        function confirmToggleStatus(id, currentStatus) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo e(url('/staff/status')); ?>/" + id,
                        type: 'POST',
                        data: {
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo e(url('/staff/delete')); ?>/" + id,
                        type: 'DELETE',
                        data: {
                            _token: "<?php echo e(csrf_token()); ?>"
                        },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Raif/Documents/Soft-UI-Dashboard-Tailwind-1.0.0/finance-website/resources/views/staff/index.blade.php ENDPATH**/ ?>